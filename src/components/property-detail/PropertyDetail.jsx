...
const PropertyDetail = () => {
  ...
  return (
    <section
      className={`${isPremiumProperty && !isPremiumUser ? "blur-md" : ""}`}
    >
              ...
              <div className="h-full w-full bg-gray-100 ">
                ...
                <div className="col-span-12 h-full w-full rounded-lg xl:col-span-9">
                  ...
                  {propertyDetails && propertyDetails?.description && (
                    <AboutProperty
                      description={
                        propertyDetails?.translated_description ||
              ...
              <div className="h-full w-full bg-gray-200 p-4">
                {propertyDetails && (
                  <OwnerDetailsCard
                    ...
                    handleClickMobileNumber={handleClickMobileNumber}
                  />
                )}
                ...
                {handleReportProperty &&
                  ...
                  !isReported &&
                  showReport && (
                    <div className="newBorder mb-7 flex flex-col justify-between gap-2  p-3 md:flex-row rounded-2xl bg-white">
                      <button
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          className="brandColor flex-1 rounded-lg px-3 py-2 text-center text-sm font-medium"
